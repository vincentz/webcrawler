...
def GetPrice(url_detail,filename):
    ...
    while True:
        ...
        list_response = urllib2.urlopen(list_req)
        list_page = list_response.read()
        html_list = list_page.decode('gbk').encode('utf-8')
...
current_url = 'http://esf.sz.fang.com/housing/89__1_0_0_0_29_0_0/'
...
while True:
    ...
    for matchurl in match:
        ...
        try:
            ...
            com_response = urllib2.urlopen(com_req)
